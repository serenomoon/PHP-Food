            ...
            <div class="owl-carousel">
                <div class="carousel-item">
                    <div class="carousel-img">
                        <img src="<?php echo $ruta."/" ?>img/carousel-1.jpg" alt="Image">
                    </div>
                ...
                <div class="carousel-item">
                    <div class="carousel-img">
                        <img src="<?php echo $ruta."/" ?>img/carousel-2.jpg" alt="Image">
                    </div>
                    <div class="carousel-text">
                ...
                <div class="carousel-item">
                    <div class="carousel-img">
                        <img src="<?php echo $ruta."/" ?>img/carousel-3.jpg" alt="Image">
                    </div>
                    <div class="carousel-text">
