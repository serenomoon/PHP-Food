  ...
  <div class="about">
      <div class="container">
          <div class="row align-items-center">
              <div class="col-lg-6">
                  <div class="about-img">
                      <img src="<?php echo $ruta."/" ?>img/about.jpg" alt="Image">
              ...
              <div class="col-lg-5">
                  ...
                  <div class="feature-text">
                      <div class="feature-img">
                          <div class="row">
                              <div class="col-6">
                                  <img src="<?php echo $ruta."/" ?>img/feature-1.jpg" alt="Image">
                              </div>
                              <div class="col-6">
                                  <img src="<?php echo $ruta."/" ?>img/feature-2.jpg" alt="Image">
                              </div>
                              <div class="col-6">
                                  <img src="<?php echo $ruta."/" ?>img/feature-3.jpg" alt="Image">
                              </div>
                              <div class="col-6">
                                  <img src="<?php echo $ruta."/" ?>img/feature-4.jpg" alt="Image">
                              </div>
                          </div>
                      </div>
                      <p>
                  ...
                  <div id="burgers" class="container tab-pane active">
                      <div class="row">
                          <div class="col-lg-7 col-md-12">
                              <div class="menu-item">
                                  <div class="menu-img">
                                      <img src="<?php echo $ruta."/" ?>img/menu-burger.jpg" alt="Image">
                                  </div>
                                  <div class="menu-text">
                          ...
                          <div class="col-lg-5 d-none d-lg-block">
                              <img src="<?php echo $ruta."/" ?>img/menu-burger-img.jpg" alt="Image">
                          </div>
                      </div>
                  </div>
                  <div id="snacks" class="container tab-pane fade">
                      <div class="row">
                          <div class="col-lg-7 col-md-12">
                              <div class="menu-item">
                                  <div class="menu-img">
                                      <img src="<?php echo $ruta."/" ?>img/menu-snack.jpg" alt="Image">
                                  </div>
                                  <div class="menu-text">
                          ...
                          <div class="col-lg-5 d-none d-lg-block">
                              <img src="<?php echo $ruta."/" ?>img/menu-snack-img.jpg" alt="Image">
                          </div>
                      </div>
                  </div>
                  <div id="beverages" class="container tab-pane fade">
                      <div class="row">
                          <div class="col-lg-7 col-md-12">
                              <div class="menu-item">
                                  <div class="menu-img">
                                      <img src="<?php echo $ruta."/" ?>img/menu-beverage.jpg" alt="Image">
                                  </div>
                                  <div class="menu-text">
                          ...
                          <div class="col-lg-5 d-none d-lg-block">
                              <img src="<?php echo $ruta."/" ?>img/menu-beverage-img.jpg" alt="Image">
                          </div>
                      </div>
                  </div>
              </div>
      ...
      <div class="container">
          ...
          <div class="row">
              <div class="col-lg-3 col-md-6">
                  <div class="team-item">
                      <div class="team-img">
                          <img src="<?php echo $ruta."/" ?>img/team-1.jpg" alt="Image">
              ...
              <div class="col-lg-3 col-md-6">
                  <div class="team-item">
                      <div class="team-img">
                          <img src="<?php echo $ruta."/" ?>img/team-2.jpg" alt="Image">
                          <div class="team-social">
                              <a href=""><i class="fab fa-twitter"></i></a>
                              <a href=""><i class="fab fa-facebook-f"></i></a>
                              <a href=""><i class="fab fa-linkedin-in"></i></a>
              ...
              <div class="col-lg-3 col-md-6">
                  <div class="team-item">
                      <div class="team-img">
                          <img src="<?php echo $ruta."/" ?>img/team-3.jpg" alt="Image">
                          <div class="team-social">
                              <a href=""><i class="fab fa-twitter"></i></a>
                              <a href=""><i class="fab fa-facebook-f"></i></a>
                              <a href=""><i class="fab fa-linkedin-in"></i></a>
              ...
              <div class="col-lg-3 col-md-6">
                  <div class="team-item">
                      <div class="team-img">
                          <img src="<?php echo $ruta."/" ?>img/team-4.jpg" alt="Image">
                          <div class="team-social">
                              <a href=""><i class="fab fa-twitter"></i></a>
                              <a href=""><i class="fab fa-facebook-f"></i></a>
                              <a href=""><i class="fab fa-linkedin-in"></i></a>
          ...
          <div class="owl-carousel testimonials-carousel">
              <div class="testimonial-item">
                  <div class="testimonial-img">
                      <img src="<?php echo $ruta."/" ?>img/testimonial-1.jpg" alt="Image">
                  </div>
                  <p>
              ...
              <div class="testimonial-item">
                  <div class="testimonial-img">
                      <img src="<?php echo $ruta."/" ?>img/testimonial-2.jpg" alt="Image">
                  </div>
                  <p>
                      Lorem ipsum dolor sit amet elit. Phasel nec preti mi. Curabit facilis ornare velit non vulput
                  </p>
              ...
              <div class="testimonial-item">
                  <div class="testimonial-img">
                      <img src="<?php echo $ruta."/" ?>img/testimonial-3.jpg" alt="Image">
                  </div>
                  <p>
                      Lorem ipsum dolor sit amet elit. Phasel nec preti mi. Curabit facilis ornare velit non vulput
                  </p>
              ...
              <div class="testimonial-item">
                  <div class="testimonial-img">
                      <img src="<?php echo $ruta."/" ?>img/testimonial-4.jpg" alt="Image">
                  </div>
                  <p>
                      Lorem ipsum dolor sit amet elit. Phasel nec preti mi. Curabit facilis ornare velit non vulput
                  </p>
      ...
      <div class="container">
          ...
          <div class="row">
              <div class="col-md-6">
                  <div class="blog-item">
                      <div class="blog-img">
                          <img src="<?php echo $ruta."/" ?>img/blog-1.jpg" alt="Blog">
                      </div>
              ...
              <div class="col-md-6">
                  <div class="blog-item">
                      <div class="blog-img">
                          <img src="<?php echo $ruta."/" ?>img/blog-2.jpg" alt="Blog">
                      </div>
                      <div class="blog-content">
                          <h2 class="blog-title">Lorem ipsum dolor sit amet</h2>
                          <div class="blog-meta">
